...
<img src="texpic7.jpg" alt="Your Image" style="height:500px;width:600px;margin-top:20px"> 
<div >
<h1 style="text-align:center;margin-top:20px;">Update Meter</h1>
<div style="display: flex; justify-content: center; align-items: center; padding: 10px;">
    <form action="textile/updateMeter" method="post" style="text-align: center;">
        ...
        <div style="margin-bottom: 10px;">
            <label for="update_meter" style="font-weight:bold;color:#489c9c;font-size: 25px; width: 200px; display: inline-block; text-align: center; line-height: 38px;">Update Meter:</label>
            <input type="number" id="update_meter" name="update_meter" style="width: 200px; height: 38px;" step="0.01" placeholder="Meter">
        </div>
        
        <div style="margin-bottom: 10px;">
            <label for="update_pic" style="font-weight:bold;color:#489c9c;font-size: 25px; width: 200px; display: inline-block; text-align: center; line-height: 38px;">Update Pic:</label>
            <input type="number" id="update_pic" name="update_pic" style="width: 200px; height: 38px;" step="0.01" placeholder="Pic">
        </div>
        
        <div style="margin-bottom: 10px;">
            <label for="update_pic_rate" style="font-weight:bold;color:#489c9c;font-size: 25px; width: 200px; display: inline-block; text-align: center; line-height: 38px;">Update Pic Rate:</label>
            <input type="number" id="update_pic_rate" name="update_pic_rate" style="width: 200px; height: 38px;" step="0.01" placeholder="Pic Rate">
        </div>
